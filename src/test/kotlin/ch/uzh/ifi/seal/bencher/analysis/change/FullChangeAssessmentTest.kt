...
class FullChangeAssessmentTest {
    ...
    fun noChangeDifferentClass() {
        ...
        assertFalse(FullChangeAssessment.methodChanged(m, c),"Change detected although there should not be one")
    }
    ...
    fun changeMethod() {
        ...
        assertTrue(FullChangeAssessment.methodChanged(m, c),"No change detected although there should be one")
    }
    ...
    fun classHeader() {
        ...
        assertTrue(FullChangeAssessment.methodChanged(m, c1),"No change detected although there should be one")

        // no change
        val c2 = ClassHeaderChange(clazz = Class(name = "B"))
        assertFalse(FullChangeAssessment.methodChanged(m, c2),"Change detected although there should not be one")
    }
    ...
    fun classMethodConstructor() {
        ...
        assertTrue(FullChangeAssessment.methodChanged(m, c2),"No change detected although there should be one")
        ...
        assertTrue(FullChangeAssessment.methodChanged(m, c3),"No change detected although there should be one")

        // no change

        val c4 = ClassMethodChange(clazz = Class(name = "B"), method = PlainMethod(clazz = "B", name = "<init>", params = listOf(), returnType = "void"))
        assertFalse(FullChangeAssessment.methodChanged(m, c4),"Change detected although there should not be one")

        val c5 = ClassMethodChange(clazz = Class(name = "B"), method = PlainMethod(clazz = "B", name = "<init>", params = listOf("String"), returnType = "void"))
        assertFalse(FullChangeAssessment.methodChanged(m, c5),"Change detected although there should not be one")
        ...
        assertFalse(FullChangeAssessment.methodChanged(m, c6),"Change detected although there should not be one")
    }
    ...
    fun classMethodJMHSetup() {
        ...
        assertFalse(FullChangeAssessment.methodChanged(m, c3),"Change detected although there should not be one")
